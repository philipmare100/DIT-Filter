...
if uploaded_file is not None:
    ...
    # Apply your filters
    df_filtered = df[~df['Name'].str.contains('UNC|ADJ|NEW|FIT', case=True)]
    df_filtered = df_filtered[~df_filtered['Description'].str.contains('Forecast|Budget|Target', case=True)]
